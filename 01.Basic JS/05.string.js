//***//স্ট্রিং (String) : string হল একটি ডেটা টাইপ যা টেক্সট বা অক্ষরধারা (চরিত্রের ক্রম) ধরে রাখতে ব্যবহৃত হয়। স্ট্রিং ডাবল বা সিঙ্গেল কোটেশন মার্কের মধ্যে সংজ্ঞায়িত করা হয়। এবং এটি ক্যামেল কেসে ডিক্লার করা হয়।
